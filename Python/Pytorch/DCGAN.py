...
def train(dataloader, device, netD, netG, real_label, fake_label, criterion, optimizerD, optimizerG, fixed_noise):
    # Training Loop
...
def plot_stats(G_losses, D_losses):
...
if __name__ == '__main__':
    ...
    G_losses, D_losses, img_list = train(dataloader, device, netD, netG, real_label, fake_label,
